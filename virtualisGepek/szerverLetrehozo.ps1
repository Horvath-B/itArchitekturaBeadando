$username = "renszergazda"
$Password = Read-Host "Adja meg a szervergep jelszavat: " -AsSecureString
...
$VnetName = "halozat"
$NICName = "halozatiKartya"
$SubnetName = "alhalozat"
$SubnetCidr = "10.0.0.0/24"
$VnetCidr = "10.0.0.0/16"
$NSGName    = "halozatiBiztCsopSzerver"
$PipName = "publikusIpCimSzerver"
